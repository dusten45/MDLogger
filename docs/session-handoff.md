...
- 클라이언트 자동 검증: ruff / format / ty / **pytest 257 passed, 4 skipped** 통과.
...
| #   | 항목                                            | 상태                           | 근거                                                                                                       |
| --- | ----------------------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| 1   | Qt 자동 UI 클릭 테스트 보강 (통계 창·편집 흐름) | **진행(2026-08-10 정리 세션)** | `open-items` #1 잔여분 → 통계 창·편집/삭제 다이얼로그 + 구버전 시작 마이그레이션 통합 클릭 테스트 5개 추가 |
